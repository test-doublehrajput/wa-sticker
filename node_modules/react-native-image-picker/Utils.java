...
public class Utils {
    ...
    static Bitmap.CompressFormat getBitmapCompressFormat(String mimeType) {
        switch (mimeType) {
            case "image/webp": return Bitmap.CompressFormat.WEBP; // ksr. added webp
            case "image/png": return Bitmap.CompressFormat.PNG;
            case "image/jpeg": return Bitmap.CompressFormat.JPEG;
        }
        return Bitmap.CompressFormat.WEBP; // ksr . changed to webp
    }

    static String getFileTypeFromMime(String mimeType) {
        if (mimeType == null) {
            return "webp"; // ksr. changed to webp
        }
        switch (mimeType) {
            case "image/webp": return "webp"; //ksr added webp
